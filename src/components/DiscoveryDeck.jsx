...
export default function DiscoveryDeck({ language = "en" }) {
  ...
  ], [categoryMap, language, location.pathname]);
  ...
  useEffect(() => {
    ...
    window.addEventListener("app:open-discovery", show); window.addEventListener("app:before-navigation", beforeNavigation); window.addEventListener("keydown", onKeyDown);
    return () => { window.removeEventListener("app:open-discovery", show); window.removeEventListener("app:before-navigation", beforeNavigation); window.removeEventListener("keydown", onKeyDown); };
  }, []);
  useEffect(() => {
